...
AV.init = function init(options) {
  ...
  if ("ReactNative" && masterKey) console.warn('MasterKey is not supposed to be used in browser.');
...
var comments = ["ReactNative" || 'Node.js'].concat(__webpack_require__(36));
...
var AsyncStorage = __webpack_require__(56).AsyncStorage;
